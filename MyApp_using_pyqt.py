...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QFileDialog, QSizePolicy
...
class MyApp(QWidget):
    def __init__(self):
        ...
        self.button.setMaximumWidth(200)  # Set maximum width of button
        ...
        self.button2.setMaximumWidth(200)  # Set maximum width of button
    ...
    def browse_csv(self):
        ...
        if filename:
            ...
            pdf_path_name = extract_info(filename)  # assuming this function is defined elsewhere
